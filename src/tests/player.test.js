...
describe('Player', () => {
  ...
  it('should create player with a gameboard', () => {
    ...
    const ships = [{ ship: {}, coordinates: [[1, 1], [1, 2]] }];
  ...
  test('player attack another opponent gameboard', () => {
    ...
    Gameboard.mockReturnValueOnce(mockGameBoard1).mockReturnValueOnce(mockGameBoard2)
    ...
    const ships1 = [{ ship: {}, coordinates: [[1, 1], [1, 2]] }];

    const ships2 = [{ ship: {}, coordinates: [[1, 3], [1, 4]] }];
